...
theme.setup = function(cfg)
  ...
  hi.plugins = {
    ...
    -- BufferLineTab = { fg = c.a, bg = c.b },
    -- BufferLineHint = { fg = c.a, bg = c.b },
    -- BufferLineInfo = { fg = c.a, bg = c.b },
    -- BufferLinePick = { fg = c.a, bg = c.b },
    -- BufferLineError = { fg = c.a, bg = c.b },
    -- BufferLineBuffer = { fg = c.a, bg = c.b },
    -- BufferLineNumbers = { fg = c.a, bg = c.b },
    -- BufferLineWarning = { fg = c.a, bg = c.b },
    -- BufferLineModified = { fg = c.a, bg = c.b },
    -- BufferLineTabClose = { fg = c.a, bg = c.b },
    -- BufferLineDuplicate = { fg = c.a, bg = c.b },
    -- BufferLineDiagnostic = { fg = c.a, bg = c.b },
    -- BufferLineGroupLabel = { fg = c.a, bg = c.b },
    -- BufferLineCloseButton = { fg = c.a, bg = c.b },
    -- BufferLineHintVisible = { fg = c.a, bg = c.b },
    -- BufferLineInfoVisible = { fg = c.a, bg = c.b },
    -- BufferLinePickVisible = { fg = c.a, bg = c.b },
    -- BufferLineErrorVisible = { fg = c.a, bg = c.b },
    -- BufferLineHintSelected = { fg = c.a, bg = c.b },
    -- BufferLineInfoSelected = { fg = c.a, bg = c.b },
    -- BufferLinePickSelected = { fg = c.a, bg = c.b },
    -- BufferLineTabSeparator = { fg = c.a, bg = c.b },
    -- BufferLineBufferVisible = { fg = c.a, bg = c.b },
    -- BufferLineErrorSelected = { fg = c.a, bg = c.b },
    -- BufferLineBufferSelected = { fg = c.a, bg = c.b },
    -- BufferLineGroupSeparator = { fg = c.a, bg = c.b },
    -- BufferLineHintDiagnostic = { fg = c.a, bg = c.b },
    -- BufferLineInfoDiagnostic = { fg = c.a, bg = c.b },
    -- BufferLineNumbersVisible = { fg = c.a, bg = c.b },
    -- BufferLineWarningVisible = { fg = c.a, bg = c.b },
    -- BufferLineErrorDiagnostic = { fg = c.a, bg = c.b },
    -- BufferLineModifiedVisible = { fg = c.a, bg = c.b },
    -- BufferLineNumbersSelected = { fg = c.a, bg = c.b },
    -- BufferLineOffsetSeparator = { fg = c.a, bg = c.b },
    -- BufferLineWarningSelected = { fg = c.a, bg = c.b },
    -- BufferLineDuplicateVisible = { fg = c.a, bg = c.b },
    -- BufferLineModifiedSelected = { fg = c.a, bg = c.b },
    -- BufferLineSeparatorVisible = { fg = c.a, bg = c.b },
    -- BufferLineDiagnosticVisible = { fg = c.a, bg = c.b },
    -- BufferLineDuplicateSelected = { fg = c.a, bg = c.b },
    -- BufferLineSeparatorSelected = { fg = c.a, bg = c.b },
    -- BufferLineWarningDiagnostic = { fg = c.a, bg = c.b },
    -- BufferLineCloseButtonVisible = { fg = c.a, bg = c.b },
    -- BufferLineDiagnosticSelected = { fg = c.a, bg = c.b },
    -- BufferLineCloseButtonSelected = { fg = c.a, bg = c.b },
    -- BufferLineTabSeparatorSelected = { fg = c.a, bg = c.b },
    -- BufferLineHintDiagnosticVisible = { fg = c.a, bg = c.b },
    -- BufferLineInfoDiagnosticVisible = { fg = c.a, bg = c.b },
    -- BufferLineErrorDiagnosticVisible = { fg = c.a, bg = c.b },
    -- BufferLineHintDiagnosticSelected = { fg = c.a, bg = c.b },
    -- BufferLineInfoDiagnosticSelected = { fg = c.a, bg = c.b },
    -- BufferLineErrorDiagnosticSelected = { fg = c.a, bg = c.b },
    -- BufferLineWarningDiagnosticVisible = { fg = c.a, bg = c.b },
