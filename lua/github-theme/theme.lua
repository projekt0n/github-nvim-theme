...
M.setup = function()
  ...
  hi.plugins = {
    ...
    BufferLineSeparator = { fg = c.bg_sidebar, bg = c.bg_sidebar },
    ...
    BufferLineHint = { fg = c.blue, bg = c.bg },
    BufferLineInfo = { fg = c.blue, bg = c.bg },
    BufferLinePick = { fg = c.fg, bg = c.bg },
    BufferLineError = { fg = c.red, bg = c.bg },
    BufferLineBuffer = { fg = c.fg, bg = c.bg },
    BufferLineNumbers = { fg = c.fg, bg = c.bg },
    BufferLineWarning = { fg = c.yellow, bg = c.bg },
    BufferLineModified = { fg = c.fg, bg = c.bg },
    BufferLineTabClose = { fg = c.fg, bg = c.bg },
    BufferLineDevIconLua = { fg = c.fg, bg = c.bg },
    BufferLineDiagnostic = { fg = c.fg, bg = c.bg },
    BufferLineGroupLabel = { fg = c.fg, bg = c.bg },
    BufferLineCloseButton = { fg = c.fg, bg = c.bg },
    BufferLineHintVisible = { fg = c.blue, bg = c.bg },
    BufferLineInfoVisible = { fg = c.blue, bg = c.bg },
    BufferLinePickVisible = { fg = c.fg, bg = c.bg },
    BufferLineErrorVisible = { fg = c.red, bg = c.bg },
    BufferLineHintSelected = { fg = c.blue, bg = c.bg },
    BufferLineInfoSelected = { fg = c.blue, bg = c.bg },
    BufferLinePickSelected = { fg = c.fg, bg = c.bg },
    BufferLineTabSeparator = { fg = c.red, bg = c.red },
    BufferLineErrorSelected = { fg = c.red, bg = c.bg },
    BufferLineBufferSelected = { fg = c.fg, bg = c.bg },
    BufferLineGroupSeparator = { fg = c.fg, bg = c.bg },
    BufferLineHintDiagnostic = { fg = c.blue, bg = c.bg },
    BufferLineInfoDiagnostic = { fg = c.blue, bg = c.bg },
    BufferLineNumbersVisible = { fg = c.fg, bg = c.bg },
    BufferLineWarningVisible = { fg = c.yellow, bg = c.bg },
    BufferLineErrorDiagnostic = { fg = c.red, bg = c.bg },
    BufferLineModifiedVisible = { fg = c.fg, bg = c.bg },
    BufferLineNumbersSelected = { fg = c.fg, bg = c.bg },
    BufferLineOffsetSeparator = { fg = c.fg, bg = c.bg },
    BufferLineWarningSelected = { fg = c.yellow, bg = c.bg },
    BufferLineDiagnosticVisible = { fg = c.fg, bg = c.bg },
    BufferLineSeparatorSelected = { fg = c.fg, bg = c.bg },
    BufferLineWarningDiagnostic = { fg = c.yellow, bg = c.bg },
    BufferLineCloseButtonVisible = { fg = c.fg, bg = c.bg },
    BufferLineDevIconLuaInactive = { fg = c.syntax.comment, bg = c.bg },
    BufferLineDevIconLuaSelected = { fg = c.syntax.comment, bg = c.bg },
    BufferLineDiagnosticSelected = { fg = c.fg, bg = c.bg },
    BufferLineCloseButtonSelected = { fg = c.fg, bg = c.bg },
    BufferLineTabSeparatorSelected = { fg = c.fg, bg = c.bg },
    BufferLineHintDiagnosticVisible = { fg = c.blue, bg = c.bg },
    BufferLineInfoDiagnosticVisible = { fg = c.blue, bg = c.bg },
    BufferLineErrorDiagnosticVisible = { fg = c.red, bg = c.bg },
    BufferLineHintDiagnosticSelected = { fg = c.blue, bg = c.bg },
